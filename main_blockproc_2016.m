...
imgArray = {'img1.tif','img2.tif','img3.tif'};
...
do.particleDetect = 1;  % analyze blood vessels in original TIFF image
do.requestROI = 1;      % ask the user to draw a ROI on each image
    do.analysisInROI = 1;   % analyze the blood vessel distribution within each ROI
do.createThumb = 1;     % create a thumbnail image for each ROI
